...
class Users extends UsersBase implements IdentityInterface
{
    ...
    public function rules()
    {
        return array_merge([
            ['password', 'required'],
            [['login'], 'unique','on'=>self::SCENARIO_SIGNUP],
            [['login'], 'exist','on'=>self::SCENARIO_SIGNIN]
        ],parent::rules()) ;
    }
    ...
    //получение все id пользователей
    public static function getAllIdUsers(){
        return Users::find()->select('id')->asArray()->all();
    }
}
